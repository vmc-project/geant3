...
//
   ...
   fF1 = new G3GUISliders(tf, this, 60, 20);
   tf->AddFrame(fF1,fL3);
...
G3GuiGeomDialog::~G3GuiGeomDialog()
{
...
void G3GuiGeomDialog::CloseWindow()
{
   // Called when window is closed via the window manager.
   delete this;
   gMainWindow->CloseDialog();
}

Bool_t G3GuiGeomDialog::ProcessMessage(Long_t msg, Long_t parm1, Long_t parm2)
{
