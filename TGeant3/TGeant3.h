...
public:
   ...
   Bool_t DefineParticle(Int_t pdg, const char *name, TMCParticleType mcType, Double_t mass, Double_t charge,
                         Double_t lifetime);
   Bool_t DefineParticle(Int_t pdg, const char *name, TMCParticleType mcType, Double_t mass, Double_t charge,
                         ...
                         Bool_t /*shortlived*/ = kFALSE, const TString & /*subType*/ = "", Int_t /*antiEncoding*/ = 0,
                         Double_t /*magMoment*/ = 0.0, Double_t /*excitation*/ = 0.0);
   ...
   // the material
   Bool_t GetMaterial(Int_t imat, TString &name, Double_t &a, Double_t &z, Double_t &density, Double_t &radl,
                      Double_t &inter, TArrayD &par);
   // Returns the material parameters for the volume specified by
   // the volume name.
   Bool_t GetMaterial(const TString &volumeName, TString &name, Int_t &imat, Double_t &a, Double_t &z, Double_t &den,
                      Double_t &radl, Double_t &inter, TArrayD &par);
   // Returns the medium parameters for the volume specified by the
   // volume name.
   Bool_t GetMedium(const TString &volumeName, TString &name, Int_t &imed, Int_t &nmat, Int_t &isvol, Int_t &ifield,
                    Double_t &fieldm, Double_t &tmaxfd, Double_t &stemax, Double_t &deemax, Double_t &epsil,
   ...
   virtual void Gfmate(Int_t imat, char *name, Float_t &a, Float_t &z, Float_t &dens, Float_t &radl, Float_t &absl,
                       Float_t *ubuf, Int_t &nbuf);
   virtual void Gfmate2(Int_t imat, char *name, Float_t &a, Float_t &z, Float_t &dens, Float_t &radl, Float_t &absl,
                        Float_t *ubuf, Int_t &nbuf);
   virtual void Gfmate(Int_t imat, char *name, Double_t &a, Double_t &z, Double_t &dens, Double_t &radl, Double_t &absl,
                       Double_t *ubuf, Int_t &nbuf);
   virtual void Gfpart(Int_t ipart, char *name, Int_t &itrtyp, Float_t &amass, Float_t &charge, Float_t &tlife) const;
   virtual void Gftmed(Int_t numed, char *name, Int_t &nmat, Int_t &isvol, Int_t &ifield, Float_t &fieldm,
                       Float_t &tmaxfd, Float_t &stemax, Float_t &deemax, Float_t &epsil, Float_t &stmin,
                       Float_t *buf = 0, Int_t *nbuf = 0);
   virtual void Gftmat(Int_t imate, Int_t ipart, char *chmeca, Int_t kdim, Float_t *tkin, Float_t *value, Float_t *pcut,
                       Int_t &ixst);
   ...
   virtual void Gstmed(Int_t numed, const char *name, Int_t nmat, Int_t isvol, Int_t ifield, Float_t fieldm,
                       Float_t tmaxfd, Float_t stemax, Float_t deemax, Float_t epsil, Float_t stmin);
   ...
   virtual void Gdraw(const char *name, Double_t theta = 30, Double_t phi = 30, Double_t psi = 0, Double_t u0 = 10,
                      Double_t v0 = 10, Double_t ul = 0.01, Double_t vl = 0.01);
   virtual void Gdrawc(const char *name, Int_t axis = 1, Float_t cut = 0, Float_t u0 = 10, Float_t v0 = 10,
                       Float_t ul = 0.01, Float_t vl = 0.01);
   virtual void Gdrawx(const char *name, Float_t cutthe, Float_t cutphi, Float_t cutval, Float_t theta = 30,
                       Float_t phi = 30, Float_t u0 = 10, Float_t v0 = 10, Float_t ul = 0.01, Float_t vl = 0.01);
   ...
   virtual void SetClipBox(const char *name, Double_t xmin = -9999, Double_t xmax = 0, Double_t ymin = -9999,
                           Double_t ymax = 0, Double_t zmin = -9999, Double_t zmax = 0);
   ...
   virtual void SetCUTS(Float_t cutgam, Float_t cutele, Float_t cutneu, Float_t cuthad, Float_t cutmuo, Float_t bcute,
                        Float_t bcutm, Float_t dcute, Float_t dcutm, Float_t ppcutm, Float_t tofmax, Float_t *gcuts);
   virtual void InitGEANE();
   virtual void SetClose(Int_t iclose, Float_t *pf, Float_t dstrt, Float_t *w1, Float_t *w2, Float_t *p1, Float_t *p2,
                         Float_t *p3, Float_t *cl);
   ...
   virtual void SetKINE(Int_t kine, Float_t xk1 = 0, Float_t xk2 = 0, Float_t xk3 = 0, Float_t xk4 = 0, Float_t xk5 = 0,
                        Float_t xk6 = 0, Float_t xk7 = 0, Float_t xk8 = 0, Float_t xk9 = 0, Float_t xk10 = 0);
   ...
   virtual void Trscsd(Float_t *pc, Float_t *rc, Float_t *pd, Float_t *rd, Float_t *h, Float_t ch, Int_t ierr,
   ...
   void SetTrack(Int_t done, Int_t parent, Int_t pdg, Float_t *pmom, Float_t *vpos, Float_t *polar, Float_t tof,
...
protected:
   ...
   void G3Material(Int_t &kmat, const char *name, Double_t a, Double_t z, Double_t dens, Double_t radl, Double_t absl,
   ...
   void G3Medium(Int_t &kmed, const char *name, Int_t nmat, Int_t isvol, Int_t ifield, Double_t fieldm, Double_t tmaxfd,
                 Double_t stemax, Double_t deemax, Double_t epsil, Double_t stmin, Float_t *ubuf = 0, Int_t nbuf = 0);
   Int_t G3Gsvolu(const char *name, const char *shape, Int_t nmed, Float_t *upar, Int_t np);
   void G3Gsposp(const char *name, Int_t nr, const char *mother, Double_t x, Double_t y, Double_t z, Int_t irot,
                 const char *konly, Float_t *upar, Int_t np);
